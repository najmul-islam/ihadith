const Setting = () => {
  return (
    <div className="hidden 2xl:flex flex-col gap-3">
      <div className="rounded-xl text-[17px] p-4 bg-white ">
        <h2 className="text-2xl text-center">সেটিংস</h2>
      ...
      <div className="relative p-4 text-center bg-[#34AB82] rounded-xl text-white">
        ...
        <p className="mt-2 tracking-wide text-start">
          ...
          প্রজেক্টে হাদিয়া দিন। ইনশাআল্লাহ এটি সদাকায়ে জারিয়াহ হিসেবে
          আল্লাহ্&zwnj;র কাছে কবুল হবে।
        </p>
