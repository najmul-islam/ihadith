    ...
    <Link href="/books/bukhari">
      ...
      >
        <div className="relative h-12 w-12 flex justify-center items-center">
          <h3
            className={`font-inter group-hover:text-white absolute text-xl font-medium ${
          ...
          <svg
            class={` group-hover:fill-[#2A9E76] dark:fill-dark-bg-lite group-hover:fill-subcat-hover ${
        ...
        <div className="flex flex-col gap-1">
          <h2 className="leading-7 text-black text-[17px]">সহিহ বুখারী</h2>
          <h6 className="text-[#40404099] text-[15px]">সর্বমোট হাদিস - ৭৫৬৩</h6>
        </div>
      </div>
    </Link>
  );
