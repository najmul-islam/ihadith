...
const FilterBox = () => {
  ...
  return (
    <form
      ...
      className="flex items-center w-full p-4 font-inter"
    >
      <label
        htmlFor="search"
        className="p-3 rounded-lg flex items-center gap-2 w-full bg-[#F2F4F6]"
      >
        <svg
        ...
        <input
          ...
          className="outline-none w-full bg-[#F2F4F6]"
        />
      </label>
    </form>
  );
